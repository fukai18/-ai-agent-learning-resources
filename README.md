...
### [2026-03-17] 🎯 实战沉淀：Agent PM 黑盒管理工作流
* **主题**: 解决 Token 爆炸与限速的“赛博管理学”
* **核心内容**: [Agent PM 实战指南](./best-practices/agent-pm-workflow/README.md)
  - **核心思想**：不看代码看输出，抽样检查避限速。
  - **关键动作**：模块化增量交付、跨 Session 状态隔离、环境依赖先行。
* **实战案例**: 基于日前微电网经济调度项目的开发全过程总结。
...
* **实战指南**: [Agent PM 实战指南](./best-practices/agent-pm-workflow/README.md)
